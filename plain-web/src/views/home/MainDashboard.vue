<template>
  <div class="grids">
    ...
    <div class="card sec-card" @click="openSecuritySettings">
      <div class="card-content">
        <div class="sec-row">
          <i-material-symbols:shield-lock-outline-rounded class="sec-icon" />
          <div class="sec-text">
            <div class="sec-title">Feedback security question</div>
            <div class="sec-sub">Change the question and answer that opens this dashboard.</div>
          </div>
          <i-lucide:chevron-right class="sec-chevron" />
        </div>
      </div>
    </div>
  </div>
...
import FeedbackSettingsModal from './FeedbackSettingsModal.vue'
...
function openSecuritySettings() {
  pushModal(FeedbackSettingsModal)
}
</script>
